...
(async () => {
  ...
  try {
    ...
    console.log('PASS: mixed defaults, read-only fee estimates, exact generation retry after lost response, and discounted draft balance offered for later billing');
  } catch (error) {
